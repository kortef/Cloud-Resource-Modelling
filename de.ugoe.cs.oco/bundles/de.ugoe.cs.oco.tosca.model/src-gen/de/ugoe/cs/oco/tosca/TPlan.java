 ...
 * </p>
 * <ul>
 *   <li>{@link de.ugoe.cs.oco.tosca.TPlan#getPrecondition <em>Precondition</em>}</li>
 *   <li>{@link de.ugoe.cs.oco.tosca.TPlan#getInputParameters <em>Input Parameters</em>}</li>
 *   <li>{@link de.ugoe.cs.oco.tosca.TPlan#getOutputParameters <em>Output Parameters</em>}</li>
 *   <li>{@link de.ugoe.cs.oco.tosca.TPlan#getPlanModel <em>Plan Model</em>}</li>
 *   <li>{@link de.ugoe.cs.oco.tosca.TPlan#getPlanModelReference <em>Plan Model Reference</em>}</li>
 *   <li>{@link de.ugoe.cs.oco.tosca.TPlan#getId <em>Id</em>}</li>
 *   <li>{@link de.ugoe.cs.oco.tosca.TPlan#getName <em>Name</em>}</li>
 *   <li>{@link de.ugoe.cs.oco.tosca.TPlan#getPlanLanguage <em>Plan Language</em>}</li>
 *   <li>{@link de.ugoe.cs.oco.tosca.TPlan#getPlanType <em>Plan Type</em>}</li>
 * </ul>
 *
 * @see de.ugoe.cs.oco.tosca.ToscaPackage#getTPlan()
...
public interface TPlan extends TExtensibleElements {
	...
	/**
	 * Sets the value of the '{@link de.ugoe.cs.oco.tosca.TPlan#getPrecondition <em>Precondition</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Sets the value of the '{@link de.ugoe.cs.oco.tosca.TPlan#getPlanModel <em>Plan Model</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Sets the value of the '{@link de.ugoe.cs.oco.tosca.TPlan#getPlanModelReference <em>Plan Model Reference</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Sets the value of the '{@link de.ugoe.cs.oco.tosca.TPlan#getId <em>Id</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Sets the value of the '{@link de.ugoe.cs.oco.tosca.TPlan#getName <em>Name</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Sets the value of the '{@link de.ugoe.cs.oco.tosca.TPlan#getPlanLanguage <em>Plan Language</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Sets the value of the '{@link de.ugoe.cs.oco.tosca.TPlan#getPlanType <em>Plan Type</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
