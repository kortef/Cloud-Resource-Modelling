...
/**
 * This is the item provider adapter for a {@link pcg.Edge} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EdgeItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 PcgPackage.Literals.EDGE__TARGET,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 PcgPackage.Literals.EDGE__SOURCE,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addKindPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Edge_kind_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Edge_kind_feature", "_UI_Edge_type"),
				 PcgPackage.Literals.EDGE__KIND,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 PcgPackage.Literals.EDGE__WEIGHT,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((Edge)object).getKind();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Edge.class)) {
			case PcgPackage.EDGE__KIND:
			case PcgPackage.EDGE__WEIGHT:
