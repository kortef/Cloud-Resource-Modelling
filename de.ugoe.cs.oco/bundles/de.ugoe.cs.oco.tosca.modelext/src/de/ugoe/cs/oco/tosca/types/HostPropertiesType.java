 ...
 * </p>
 * <ul>
 *   <li>{@link de.ugoe.cs.oco.tosca.types.HostPropertiesType#getOpenstackConfig <em>Openstack Config</em>}</li>
 *   <li>{@link de.ugoe.cs.oco.tosca.types.HostPropertiesType#getManagementNetworkName <em>Management Network Name</em>}</li>
 *   <li>{@link de.ugoe.cs.oco.tosca.types.HostPropertiesType#getAgentConfig <em>Agent Config</em>}</li>
 *   <li>{@link de.ugoe.cs.oco.tosca.types.HostPropertiesType#getCloudifyAgent <em>Cloudify Agent</em>}</li>
 *   <li>{@link de.ugoe.cs.oco.tosca.types.HostPropertiesType#getServer <em>Server</em>}</li>
 * </ul>
 *
 * @see de.ugoe.cs.oco.tosca.types.TypesPackage#getHostPropertiesType()
...
public interface HostPropertiesType extends EObject {
	 ...
	 * @see de.ugoe.cs.oco.tosca.types.TypesPackage#getHostPropertiesType_OpenstackConfig()
	...
	/**
	 * Sets the value of the '{@link de.ugoe.cs.oco.tosca.types.HostPropertiesType#getOpenstackConfig <em>Openstack Config</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see de.ugoe.cs.oco.tosca.types.TypesPackage#getHostPropertiesType_ManagementNetworkName()
	 * @model dataType="org.eclipse.emf.ecore.xml.type.String" required="true"
	...
	/**
	 * Sets the value of the '{@link de.ugoe.cs.oco.tosca.types.HostPropertiesType#getManagementNetworkName <em>Management Network Name</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see de.ugoe.cs.oco.tosca.types.TypesPackage#getHostPropertiesType_AgentConfig()
	 * @model dataType="org.eclipse.emf.ecore.xml.type.String" required="true"
	...
	/**
	 * Sets the value of the '{@link de.ugoe.cs.oco.tosca.types.HostPropertiesType#getAgentConfig <em>Agent Config</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see de.ugoe.cs.oco.tosca.types.TypesPackage#getHostPropertiesType_CloudifyAgent()
	...
	/**
	 * Sets the value of the '{@link de.ugoe.cs.oco.tosca.types.HostPropertiesType#getCloudifyAgent <em>Cloudify Agent</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see de.ugoe.cs.oco.tosca.types.TypesPackage#getHostPropertiesType_Server()
	 * @model containment="true" required="true"
	...
	/**
	 * Sets the value of the '{@link de.ugoe.cs.oco.tosca.types.HostPropertiesType#getServer <em>Server</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
