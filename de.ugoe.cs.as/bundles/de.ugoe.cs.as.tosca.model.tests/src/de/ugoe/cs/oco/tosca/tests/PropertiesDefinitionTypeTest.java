...
public class PropertiesDefinitionTypeTest extends TestCase {
	...
	/**
	 * The fixture for this Properties Definition Type test case.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected PropertiesDefinitionType fixture = null;
	...
	public static void main(String[] args) {
		TestRunner.run(PropertiesDefinitionTypeTest.class);
	}

	/**
	 * Constructs a new Properties Definition Type test case with the given name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public PropertiesDefinitionTypeTest(String name) {
		super(name);
	}

	/**
	 * Sets the fixture for this Properties Definition Type test case.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void setFixture(PropertiesDefinitionType fixture) {
		this.fixture = fixture;
	}

	/**
	 * Returns the fixture for this Properties Definition Type test case.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected PropertiesDefinitionType getFixture() {
		return fixture;
	}
	...
	protected void setUp() throws Exception {
		setFixture(ToscaFactory.eINSTANCE.createPropertiesDefinitionType());
	}
