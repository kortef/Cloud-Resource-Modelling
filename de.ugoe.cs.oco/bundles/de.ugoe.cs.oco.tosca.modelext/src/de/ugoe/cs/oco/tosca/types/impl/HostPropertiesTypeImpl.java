 ...
 * </p>
 * <ul>
 *   <li>{@link de.ugoe.cs.oco.tosca.types.impl.HostPropertiesTypeImpl#getOpenstackConfig <em>Openstack Config</em>}</li>
 *   <li>{@link de.ugoe.cs.oco.tosca.types.impl.HostPropertiesTypeImpl#getManagementNetworkName <em>Management Network Name</em>}</li>
 *   <li>{@link de.ugoe.cs.oco.tosca.types.impl.HostPropertiesTypeImpl#getAgentConfig <em>Agent Config</em>}</li>
 *   <li>{@link de.ugoe.cs.oco.tosca.types.impl.HostPropertiesTypeImpl#getCloudifyAgent <em>Cloudify Agent</em>}</li>
 *   <li>{@link de.ugoe.cs.oco.tosca.types.impl.HostPropertiesTypeImpl#getServer <em>Server</em>}</li>
 * </ul>
 *
 * @generated
 */
