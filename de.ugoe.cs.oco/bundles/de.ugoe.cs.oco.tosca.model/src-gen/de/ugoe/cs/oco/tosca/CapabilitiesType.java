 ...
 * </p>
 * <ul>
 *   <li>{@link de.ugoe.cs.oco.tosca.CapabilitiesType#getCapability <em>Capability</em>}</li>
 * </ul>
 *
 * @see de.ugoe.cs.oco.tosca.ToscaPackage#getCapabilitiesType()
...
public interface CapabilitiesType extends EObject {
	 ...
	 * @see de.ugoe.cs.oco.tosca.ToscaPackage#getCapabilitiesType_Capability()
	 * @model containment="true" required="true"
	 *        extendedMetaData="kind='element' name='Capability' namespace='##targetNamespace'"
	 *        annotation="http://www.eclipse.org/emf/2002/GenModel get='throw new UnsupportedOperationException();  // FIXME Unimplemented http://oco.cs.ugoe.de/tosca!CapabilitiesType!capability'"
	 * @generated
	 */
