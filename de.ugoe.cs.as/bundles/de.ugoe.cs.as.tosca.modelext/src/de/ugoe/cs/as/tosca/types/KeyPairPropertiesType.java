 ...
 * </p>
 * <ul>
 *   <li>{@link de.ugoe.cs.as.tosca.types.KeyPairPropertiesType#getOpenstackConfig <em>Openstack Config</em>}</li>
 *   <li>{@link de.ugoe.cs.as.tosca.types.KeyPairPropertiesType#getUseExternalResource <em>Use External Resource</em>}</li>
 *   <li>{@link de.ugoe.cs.as.tosca.types.KeyPairPropertiesType#getResourceId <em>Resource Id</em>}</li>
 *   <li>{@link de.ugoe.cs.as.tosca.types.KeyPairPropertiesType#getPrivateKeyPath <em>Private Key Path</em>}</li>
 * </ul>
 *
 * @see de.ugoe.cs.as.tosca.types.TypesPackage#getKeyPairPropertiesType()
...
public interface KeyPairPropertiesType extends EObject {
	 ...
	 * @see de.ugoe.cs.as.tosca.types.TypesPackage#getKeyPairPropertiesType_OpenstackConfig()
	...
	/**
	 * Sets the value of the '{@link de.ugoe.cs.as.tosca.types.KeyPairPropertiesType#getOpenstackConfig <em>Openstack Config</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see de.ugoe.cs.as.tosca.types.TypesPackage#getKeyPairPropertiesType_UseExternalResource()
	 * @model dataType="org.eclipse.emf.ecore.xml.type.String" required="true"
	...
	/**
	 * Sets the value of the '{@link de.ugoe.cs.as.tosca.types.KeyPairPropertiesType#getUseExternalResource <em>Use External Resource</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see de.ugoe.cs.as.tosca.types.TypesPackage#getKeyPairPropertiesType_ResourceId()
	 * @model dataType="org.eclipse.emf.ecore.xml.type.String" required="true"
	...
	/**
	 * Sets the value of the '{@link de.ugoe.cs.as.tosca.types.KeyPairPropertiesType#getResourceId <em>Resource Id</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see de.ugoe.cs.as.tosca.types.TypesPackage#getKeyPairPropertiesType_PrivateKeyPath()
	 * @model dataType="org.eclipse.emf.ecore.xml.type.String" required="true"
	...
	/**
	 * Sets the value of the '{@link de.ugoe.cs.as.tosca.types.KeyPairPropertiesType#getPrivateKeyPath <em>Private Key Path</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
