 ...
 * </p>
 * <ul>
 *   <li>{@link de.ugoe.cs.oco.tosca.PoliciesType1#getPolicy <em>Policy</em>}</li>
 * </ul>
 *
 * @see de.ugoe.cs.oco.tosca.ToscaPackage#getPoliciesType1()
...
public interface PoliciesType1 extends EObject {
	 ...
	 * @see de.ugoe.cs.oco.tosca.ToscaPackage#getPoliciesType1_Policy()
	 * @model containment="true" required="true"
	 *        extendedMetaData="kind='element' name='Policy' namespace='##targetNamespace'"
	 *        annotation="http://www.eclipse.org/emf/2002/GenModel get='throw new UnsupportedOperationException();  // FIXME Unimplemented http://oco.cs.ugoe.de/tosca!PoliciesType1!policy'"
	 * @generated
	 */
