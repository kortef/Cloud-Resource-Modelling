 ...
 * </p>
 * <ul>
 *   <li>{@link de.ugoe.cs.oco.tosca.impl.TDefinitionsImpl#getExtensions <em>Extensions</em>}</li>
 *   <li>{@link de.ugoe.cs.oco.tosca.impl.TDefinitionsImpl#getImport <em>Import</em>}</li>
 *   <li>{@link de.ugoe.cs.oco.tosca.impl.TDefinitionsImpl#getTypes <em>Types</em>}</li>
 *   <li>{@link de.ugoe.cs.oco.tosca.impl.TDefinitionsImpl#getGroup <em>Group</em>}</li>
 *   <li>{@link de.ugoe.cs.oco.tosca.impl.TDefinitionsImpl#getServiceTemplate <em>Service Template</em>}</li>
 *   <li>{@link de.ugoe.cs.oco.tosca.impl.TDefinitionsImpl#getNodeType <em>Node Type</em>}</li>
 *   <li>{@link de.ugoe.cs.oco.tosca.impl.TDefinitionsImpl#getNodeTypeImplementation <em>Node Type Implementation</em>}</li>
 *   <li>{@link de.ugoe.cs.oco.tosca.impl.TDefinitionsImpl#getRelationshipType <em>Relationship Type</em>}</li>
 *   <li>{@link de.ugoe.cs.oco.tosca.impl.TDefinitionsImpl#getRelationshipTypeImplementation <em>Relationship Type Implementation</em>}</li>
 *   <li>{@link de.ugoe.cs.oco.tosca.impl.TDefinitionsImpl#getRequirementType <em>Requirement Type</em>}</li>
 *   <li>{@link de.ugoe.cs.oco.tosca.impl.TDefinitionsImpl#getCapabilityType <em>Capability Type</em>}</li>
 *   <li>{@link de.ugoe.cs.oco.tosca.impl.TDefinitionsImpl#getArtifactType <em>Artifact Type</em>}</li>
