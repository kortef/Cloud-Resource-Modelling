 ...
 * </p>
 * <ul>
 *   <li>{@link de.ugoe.cs.oco.tosca.CapabilityDefinitionsType#getCapabilityDefinition <em>Capability Definition</em>}</li>
 * </ul>
 *
 * @see de.ugoe.cs.oco.tosca.ToscaPackage#getCapabilityDefinitionsType()
...
public interface CapabilityDefinitionsType extends EObject {
	 ...
	 * @see de.ugoe.cs.oco.tosca.ToscaPackage#getCapabilityDefinitionsType_CapabilityDefinition()
	 * @model containment="true" required="true"
	 *        extendedMetaData="kind='element' name='CapabilityDefinition' namespace='##targetNamespace'"
	 *        annotation="http://www.eclipse.org/emf/2002/GenModel get='throw new UnsupportedOperationException();  // FIXME Unimplemented http://oco.cs.ugoe.de/tosca!CapabilityDefinitionsType!capabilityDefinition'"
	 * @generated
	 */
