 ...
 * </p>
 * <ul>
 *   <li>{@link de.ugoe.cs.oco.tosca.impl.TPlanImpl#getPrecondition <em>Precondition</em>}</li>
 *   <li>{@link de.ugoe.cs.oco.tosca.impl.TPlanImpl#getInputParameters <em>Input Parameters</em>}</li>
 *   <li>{@link de.ugoe.cs.oco.tosca.impl.TPlanImpl#getOutputParameters <em>Output Parameters</em>}</li>
 *   <li>{@link de.ugoe.cs.oco.tosca.impl.TPlanImpl#getPlanModel <em>Plan Model</em>}</li>
 *   <li>{@link de.ugoe.cs.oco.tosca.impl.TPlanImpl#getPlanModelReference <em>Plan Model Reference</em>}</li>
 *   <li>{@link de.ugoe.cs.oco.tosca.impl.TPlanImpl#getId <em>Id</em>}</li>
 *   <li>{@link de.ugoe.cs.oco.tosca.impl.TPlanImpl#getName <em>Name</em>}</li>
 *   <li>{@link de.ugoe.cs.oco.tosca.impl.TPlanImpl#getPlanLanguage <em>Plan Language</em>}</li>
 *   <li>{@link de.ugoe.cs.oco.tosca.impl.TPlanImpl#getPlanType <em>Plan Type</em>}</li>
 * </ul>
 *
 * @generated
 */
