 ...
 * </p>
 * <ul>
 *   <li>{@link de.ugoe.cs.as.tosca.impl.TDefinitionsImpl#getExtensions <em>Extensions</em>}</li>
 *   <li>{@link de.ugoe.cs.as.tosca.impl.TDefinitionsImpl#getImport <em>Import</em>}</li>
 *   <li>{@link de.ugoe.cs.as.tosca.impl.TDefinitionsImpl#getTypes <em>Types</em>}</li>
 *   <li>{@link de.ugoe.cs.as.tosca.impl.TDefinitionsImpl#getGroup <em>Group</em>}</li>
 *   <li>{@link de.ugoe.cs.as.tosca.impl.TDefinitionsImpl#getServiceTemplate <em>Service Template</em>}</li>
 *   <li>{@link de.ugoe.cs.as.tosca.impl.TDefinitionsImpl#getNodeType <em>Node Type</em>}</li>
 *   <li>{@link de.ugoe.cs.as.tosca.impl.TDefinitionsImpl#getNodeTypeImplementation <em>Node Type Implementation</em>}</li>
 *   <li>{@link de.ugoe.cs.as.tosca.impl.TDefinitionsImpl#getRelationshipType <em>Relationship Type</em>}</li>
 *   <li>{@link de.ugoe.cs.as.tosca.impl.TDefinitionsImpl#getRelationshipTypeImplementation <em>Relationship Type Implementation</em>}</li>
 *   <li>{@link de.ugoe.cs.as.tosca.impl.TDefinitionsImpl#getRequirementType <em>Requirement Type</em>}</li>
 *   <li>{@link de.ugoe.cs.as.tosca.impl.TDefinitionsImpl#getCapabilityType <em>Capability Type</em>}</li>
 *   <li>{@link de.ugoe.cs.as.tosca.impl.TDefinitionsImpl#getArtifactType <em>Artifact Type</em>}</li>
 *   <li>{@link de.ugoe.cs.as.tosca.impl.TDefinitionsImpl#getArtifactTemplate <em>Artifact Template</em>}</li>
 *   <li>{@link de.ugoe.cs.as.tosca.impl.TDefinitionsImpl#getPolicyType <em>Policy Type</em>}</li>
 *   <li>{@link de.ugoe.cs.as.tosca.impl.TDefinitionsImpl#getPolicyTemplate <em>Policy Template</em>}</li>
 *   <li>{@link de.ugoe.cs.as.tosca.impl.TDefinitionsImpl#getGroupType <em>Group Type</em>}</li>
 *   <li>{@link de.ugoe.cs.as.tosca.impl.TDefinitionsImpl#getId <em>Id</em>}</li>
 *   <li>{@link de.ugoe.cs.as.tosca.impl.TDefinitionsImpl#getName <em>Name</em>}</li>
 *   <li>{@link de.ugoe.cs.as.tosca.impl.TDefinitionsImpl#getTargetNamespace <em>Target Namespace</em>}</li>
 * </ul>
 *
 * @generated
 */
