 ...
 * </p>
 * <ul>
 *   <li>{@link de.ugoe.cs.oco.tosca.impl.TNodeTypeImplementationImpl#getTags <em>Tags</em>}</li>
 *   <li>{@link de.ugoe.cs.oco.tosca.impl.TNodeTypeImplementationImpl#getDerivedFrom <em>Derived From</em>}</li>
 *   <li>{@link de.ugoe.cs.oco.tosca.impl.TNodeTypeImplementationImpl#getRequiredContainerFeatures <em>Required Container Features</em>}</li>
 *   <li>{@link de.ugoe.cs.oco.tosca.impl.TNodeTypeImplementationImpl#getImplementationArtifacts <em>Implementation Artifacts</em>}</li>
 *   <li>{@link de.ugoe.cs.oco.tosca.impl.TNodeTypeImplementationImpl#getDeploymentArtifacts <em>Deployment Artifacts</em>}</li>
 *   <li>{@link de.ugoe.cs.oco.tosca.impl.TNodeTypeImplementationImpl#getAbstract <em>Abstract</em>}</li>
 *   <li>{@link de.ugoe.cs.oco.tosca.impl.TNodeTypeImplementationImpl#getFinal <em>Final</em>}</li>
 *   <li>{@link de.ugoe.cs.oco.tosca.impl.TNodeTypeImplementationImpl#getName <em>Name</em>}</li>
 *   <li>{@link de.ugoe.cs.oco.tosca.impl.TNodeTypeImplementationImpl#getNodeType <em>Node Type</em>}</li>
 *   <li>{@link de.ugoe.cs.oco.tosca.impl.TNodeTypeImplementationImpl#getTargetNamespace <em>Target Namespace</em>}</li>
 * </ul>
 *
 * @generated
 */
