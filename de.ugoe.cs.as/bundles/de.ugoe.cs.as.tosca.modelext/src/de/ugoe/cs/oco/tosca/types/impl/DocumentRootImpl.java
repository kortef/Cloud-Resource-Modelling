 ...
 * </p>
 * <ul>
 *   <li>{@link de.ugoe.cs.oco.tosca.types.impl.DocumentRootImpl#getMixed <em>Mixed</em>}</li>
 *   <li>{@link de.ugoe.cs.oco.tosca.types.impl.DocumentRootImpl#getXMLNSPrefixMap <em>XMLNS Prefix Map</em>}</li>
 *   <li>{@link de.ugoe.cs.oco.tosca.types.impl.DocumentRootImpl#getXSISchemaLocation <em>XSI Schema Location</em>}</li>
 *   <li>{@link de.ugoe.cs.oco.tosca.types.impl.DocumentRootImpl#getCloudifyAgentProperties <em>Cloudify Agent Properties</em>}</li>
 *   <li>{@link de.ugoe.cs.oco.tosca.types.impl.DocumentRootImpl#getFloatingIPProperties <em>Floating IP Properties</em>}</li>
 *   <li>{@link de.ugoe.cs.oco.tosca.types.impl.DocumentRootImpl#getKeyPairProperties <em>Key Pair Properties</em>}</li>
 *   <li>{@link de.ugoe.cs.oco.tosca.types.impl.DocumentRootImpl#getMPIHostProperties <em>MPI Host Properties</em>}</li>
 *   <li>{@link de.ugoe.cs.oco.tosca.types.impl.DocumentRootImpl#getOpenStackFloatingIPProperties <em>Open Stack Floating IP Properties</em>}</li>
 *   <li>{@link de.ugoe.cs.oco.tosca.types.impl.DocumentRootImpl#getOpenStackProperties <em>Open Stack Properties</em>}</li>
 *   <li>{@link de.ugoe.cs.oco.tosca.types.impl.DocumentRootImpl#getOpenStackVolumeProperties <em>Open Stack Volume Properties</em>}</li>
 *   <li>{@link de.ugoe.cs.oco.tosca.types.impl.DocumentRootImpl#getScalingGroupProperties <em>Scaling Group Properties</em>}</li>
 *   <li>{@link de.ugoe.cs.oco.tosca.types.impl.DocumentRootImpl#getVolumeHostPropertiesType <em>Volume Host Properties Type</em>}</li>
 * </ul>
 *
 * @generated
 */
