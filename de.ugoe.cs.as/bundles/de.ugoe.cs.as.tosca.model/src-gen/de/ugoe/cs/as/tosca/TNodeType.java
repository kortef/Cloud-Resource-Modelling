 ...
 * </p>
 * <ul>
 *   <li>{@link de.ugoe.cs.as.tosca.TNodeType#getRequirementDefinitions <em>Requirement Definitions</em>}</li>
 *   <li>{@link de.ugoe.cs.as.tosca.TNodeType#getCapabilityDefinitions <em>Capability Definitions</em>}</li>
 *   <li>{@link de.ugoe.cs.as.tosca.TNodeType#getInstanceStates <em>Instance States</em>}</li>
 *   <li>{@link de.ugoe.cs.as.tosca.TNodeType#getInterfaces <em>Interfaces</em>}</li>
 * </ul>
 *
 * @see de.ugoe.cs.as.tosca.ToscaPackage#getTNodeType()
...
public interface TNodeType extends TEntityType {
	 ...
	 * @see de.ugoe.cs.as.tosca.ToscaPackage#getTNodeType_RequirementDefinitions()
	...
	/**
	 * Sets the value of the '{@link de.ugoe.cs.as.tosca.TNodeType#getRequirementDefinitions <em>Requirement Definitions</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see de.ugoe.cs.as.tosca.ToscaPackage#getTNodeType_CapabilityDefinitions()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link de.ugoe.cs.as.tosca.TNodeType#getCapabilityDefinitions <em>Capability Definitions</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see de.ugoe.cs.as.tosca.ToscaPackage#getTNodeType_InstanceStates()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link de.ugoe.cs.as.tosca.TNodeType#getInstanceStates <em>Instance States</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see de.ugoe.cs.as.tosca.ToscaPackage#getTNodeType_Interfaces()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link de.ugoe.cs.as.tosca.TNodeType#getInterfaces <em>Interfaces</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
