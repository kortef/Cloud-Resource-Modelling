 ...
 * </p>
 * <ul>
 *   <li>{@link de.ugoe.cs.as.tosca.PoliciesType#getPolicy <em>Policy</em>}</li>
 * </ul>
 *
 * @see de.ugoe.cs.as.tosca.ToscaPackage#getPoliciesType()
...
public interface PoliciesType extends EObject {
	 ...
	 * @see de.ugoe.cs.as.tosca.ToscaPackage#getPoliciesType_Policy()
