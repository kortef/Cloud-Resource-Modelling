 ...
 * </p>
 * <ul>
 *   <li>{@link de.ugoe.cs.oco.tosca.impl.TServiceTemplateImpl#getTags <em>Tags</em>}</li>
 *   <li>{@link de.ugoe.cs.oco.tosca.impl.TServiceTemplateImpl#getBoundaryDefinitions <em>Boundary Definitions</em>}</li>
 *   <li>{@link de.ugoe.cs.oco.tosca.impl.TServiceTemplateImpl#getTopologyTemplate <em>Topology Template</em>}</li>
 *   <li>{@link de.ugoe.cs.oco.tosca.impl.TServiceTemplateImpl#getPlans <em>Plans</em>}</li>
 *   <li>{@link de.ugoe.cs.oco.tosca.impl.TServiceTemplateImpl#getId <em>Id</em>}</li>
 *   <li>{@link de.ugoe.cs.oco.tosca.impl.TServiceTemplateImpl#getName <em>Name</em>}</li>
 *   <li>{@link de.ugoe.cs.oco.tosca.impl.TServiceTemplateImpl#getSubstitutableNodeType <em>Substitutable Node Type</em>}</li>
 *   <li>{@link de.ugoe.cs.oco.tosca.impl.TServiceTemplateImpl#getTargetNamespace <em>Target Namespace</em>}</li>
 * </ul>
 *
 * @generated
 */
