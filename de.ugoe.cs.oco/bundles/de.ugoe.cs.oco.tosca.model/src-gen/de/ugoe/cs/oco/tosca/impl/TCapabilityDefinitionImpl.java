 ...
 * </p>
 * <ul>
 *   <li>{@link de.ugoe.cs.oco.tosca.impl.TCapabilityDefinitionImpl#getConstraints <em>Constraints</em>}</li>
 *   <li>{@link de.ugoe.cs.oco.tosca.impl.TCapabilityDefinitionImpl#getCapabilityType <em>Capability Type</em>}</li>
 *   <li>{@link de.ugoe.cs.oco.tosca.impl.TCapabilityDefinitionImpl#getLowerBound <em>Lower Bound</em>}</li>
 *   <li>{@link de.ugoe.cs.oco.tosca.impl.TCapabilityDefinitionImpl#getName <em>Name</em>}</li>
 *   <li>{@link de.ugoe.cs.oco.tosca.impl.TCapabilityDefinitionImpl#getUpperBound <em>Upper Bound</em>}</li>
 *   <li>{@link de.ugoe.cs.oco.tosca.impl.TCapabilityDefinitionImpl#getCapabilityTypeRef <em>Capability Type Ref</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TCapabilityDefinitionImpl extends TExtensibleElementsImpl implements TCapabilityDefinition {
	...
	/**
	 * The cached value of the '{@link #getCapabilityTypeRef() <em>Capability Type Ref</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @ordered
	 */
	protected TCapabilityType capabilityTypeRef;

	/**
	 * This is true if the Capability Type Ref reference has been set.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	protected boolean capabilityTypeRefESet;
	 ...
	 * @generated NOT
	 */
	public TCapabilityType getCapabilityTypeRef() {
		if (capabilityTypeRef == null) {
			if (getCapabilityType() != null) {
				capabilityTypeRef = (TCapabilityType) ToscaModelUtil.resolveType(this, getCapabilityType());
		...
		if (capabilityTypeRef != null && capabilityTypeRef.eIsProxy()) {
			InternalEObject oldCapabilityTypeRef = (InternalEObject)capabilityTypeRef;
			capabilityTypeRef = (TCapabilityType)eResolveProxy(oldCapabilityTypeRef);
			if (capabilityTypeRef != oldCapabilityTypeRef) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ToscaPackage.TCAPABILITY_DEFINITION__CAPABILITY_TYPE_REF, oldCapabilityTypeRef, capabilityTypeRef));
			}
		}
		return capabilityTypeRef;
	}
	 ...
	 * @generated
	 */
	public TCapabilityType basicGetCapabilityTypeRef() {
		return capabilityTypeRef;
	}
	 ...
	 * @generated NOT
	 */
	public void setCapabilityTypeRef(TCapabilityType newCapabilityTypeRef) {
		TDefinitions remoteDef = (TDefinitions) newCapabilityTypeRef.eContainer();
		...
		if (remoteDef.equals(ownDef)) {
			derivedName = new QName(newCapabilityTypeRef.getName());
		}
		else {
			derivedName = new QName(remoteDef.getTargetNamespace(), newCapabilityTypeRef.getName());
		}
		
		setCapabilityType(derivedName);
		
		
		
		TCapabilityType oldCapabilityTypeRef = capabilityTypeRef;
		capabilityTypeRef = newCapabilityTypeRef;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ToscaPackage.TCAPABILITY_DEFINITION__CAPABILITY_TYPE_REF, oldCapabilityTypeRef, capabilityTypeRef));
	}
	 ...
	 * @generated
	 */
	public void unsetCapabilityTypeRef() {
		TCapabilityType oldCapabilityTypeRef = capabilityTypeRef;
		boolean oldCapabilityTypeRefESet = capabilityTypeRefESet;
		capabilityTypeRef = null;
		capabilityTypeRefESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, ToscaPackage.TCAPABILITY_DEFINITION__CAPABILITY_TYPE_REF, oldCapabilityTypeRef, null, oldCapabilityTypeRefESet));
	}
	 ...
	 * @generated
	 */
	public boolean isSetCapabilityTypeRef() {
		return capabilityTypeRefESet;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case ToscaPackage.TCAPABILITY_DEFINITION__CAPABILITY_TYPE_REF:
				if (resolve) return getCapabilityTypeRef();
				return basicGetCapabilityTypeRef();
		}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case ToscaPackage.TCAPABILITY_DEFINITION__UPPER_BOUND:
				...
				return;
			case ToscaPackage.TCAPABILITY_DEFINITION__CAPABILITY_TYPE_REF:
				setCapabilityTypeRef((TCapabilityType)newValue);
				return;
		}
