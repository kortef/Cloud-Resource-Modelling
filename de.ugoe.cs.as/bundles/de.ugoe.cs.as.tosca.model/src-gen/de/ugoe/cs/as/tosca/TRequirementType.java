 ...
 * </p>
 * <ul>
 *   <li>{@link de.ugoe.cs.as.tosca.TRequirementType#getRequiredCapabilityType <em>Required Capability Type</em>}</li>
 *   <li>{@link de.ugoe.cs.as.tosca.TRequirementType#getRequiredCapabilityTypeRef <em>Required Capability Type Ref</em>}</li>
 * </ul>
 *
 * @see de.ugoe.cs.as.tosca.ToscaPackage#getTRequirementType()
 ...
 *        annotation="http://www.eclipse.org/emf/2002/Ecore/OCL/Pivot superTypeMustBeRequirementType='if self.derivedFrom &lt;&gt; null then self.derivedFrom.referencedEntityType.oclIsKindOf(TRequirementType) else true endif'"
 * @generated
 */
public interface TRequirementType extends TEntityType {
	 ...
	 * @see de.ugoe.cs.as.tosca.ToscaPackage#getTRequirementType_RequiredCapabilityType()
	...
	/**
	 * Sets the value of the '{@link de.ugoe.cs.as.tosca.TRequirementType#getRequiredCapabilityType <em>Required Capability Type</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see de.ugoe.cs.as.tosca.ToscaPackage#getTRequirementType_RequiredCapabilityTypeRef()
	...
	/**
	 * Sets the value of the '{@link de.ugoe.cs.as.tosca.TRequirementType#getRequiredCapabilityTypeRef <em>Required Capability Type Ref</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
