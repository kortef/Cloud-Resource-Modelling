 ...
 * @generated
 */
public class PogPackageImpl extends EPackageImpl implements PogPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see de.ugoe.cs.oco.pog.PogPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private PogPackageImpl() {
		super(eNS_URI, PogFactory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link PogPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static PogPackage init() {
		if (isInited) return (PogPackage)EPackage.Registry.INSTANCE.getEPackage(PogPackage.eNS_URI);

		// Obtain or create and register package
		PogPackageImpl thePogPackage = (PogPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof PogPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new PogPackageImpl());

		isInited = true;

		// Create package meta-data objects
		thePogPackage.createPackageContents();

		// Initialize created meta-data
		thePogPackage.initializePackageContents();

		// Mark meta-data to indicate it can't be changed
		thePogPackage.freeze();

  
		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(PogPackage.eNS_URI, thePogPackage);
		return thePogPackage;
	}
	 ...
	 * @generated
	 */
	public EAttribute getVertex_Title() {
	 ...
	 * @generated
	 */
	public PogFactory getPogFactory() {
		return (PogFactory)getEFactoryInstance();
	}
	...
	public void createPackageContents() {
		...
		createEAttribute(vertexEClass, VERTEX__TITLE);
	...
	public void initializePackageContents() {
		...
		initEAttribute(getVertex_Title(), ecorePackage.getEString(), "title", null, 0, 1, Vertex.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
