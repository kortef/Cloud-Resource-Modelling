 ...
 * </p>
 * <ul>
 *   <li>{@link de.ugoe.cs.oco.tosca.impl.TRelationshipTypeImplementationImpl#getTags <em>Tags</em>}</li>
 *   <li>{@link de.ugoe.cs.oco.tosca.impl.TRelationshipTypeImplementationImpl#getDerivedFrom <em>Derived From</em>}</li>
 *   <li>{@link de.ugoe.cs.oco.tosca.impl.TRelationshipTypeImplementationImpl#getRequiredContainerFeatures <em>Required Container Features</em>}</li>
 *   <li>{@link de.ugoe.cs.oco.tosca.impl.TRelationshipTypeImplementationImpl#getImplementationArtifacts <em>Implementation Artifacts</em>}</li>
 *   <li>{@link de.ugoe.cs.oco.tosca.impl.TRelationshipTypeImplementationImpl#getAbstract <em>Abstract</em>}</li>
 *   <li>{@link de.ugoe.cs.oco.tosca.impl.TRelationshipTypeImplementationImpl#getFinal <em>Final</em>}</li>
 *   <li>{@link de.ugoe.cs.oco.tosca.impl.TRelationshipTypeImplementationImpl#getName <em>Name</em>}</li>
 *   <li>{@link de.ugoe.cs.oco.tosca.impl.TRelationshipTypeImplementationImpl#getRelationshipType <em>Relationship Type</em>}</li>
 *   <li>{@link de.ugoe.cs.oco.tosca.impl.TRelationshipTypeImplementationImpl#getTargetNamespace <em>Target Namespace</em>}</li>
 * </ul>
 *
 * @generated
 */
